...
const TrimPicker = ({trimLevels}) => {
    ...
    return <section className={styles.trimpicker} id="trimPicker">
        <div className={styles.trimpicker_image}>
            <motion.div className={styles.trimpicker_background_wrapper}>
                <Image 
                    src={`public/backgrounds/series-background-${parseInt(activeBackgroundIndex)+1}.jpg`}
        ...
        <div className={styles.trimpicker_text}>
            ...
            <FormGroup>
                <Label>Change the driving location...</Label>
...
/*
const TrimPicker = ({trimLevels}) => {
    // stateVariable, setterFunctionVariabke
